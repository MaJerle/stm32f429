...
/* Leds on PD12, PD13, PD14, PD15 */
	...
	TM_PWM_InitChannel(TIM4, TM_PWM_Channel_2, TM_PWM_PinsPack_2);
	/* Initialize PWM on TIM4, Channel 3 and PinsPack 2 = PD14 */
	TM_PWM_InitChannel(TIM4, TM_PWM_Channel_3, TM_PWM_PinsPack_2);
	/* Initialize PWM on TIM4, Channel 4 and PinsPack 2 = PD15 */
	TM_PWM_InitChannel(TIM4, TM_PWM_Channel_4, TM_PWM_PinsPack_2);
	
	/* Set channel 1 value, 50% duty cycle */
	TM_PWM_SetChannel(TIM4, &TIM4_Data, TM_PWM_Channel_1, TIM4_Data.Period / 2);
	/* Set channel 2 value, 33% duty cycle */
	TM_PWM_SetChannel(TIM4, &TIM4_Data, TM_PWM_Channel_2, TIM4_Data.Period / 3);
	/* Set channel 3 value, 25% duty cycle */
	TM_PWM_SetChannel(TIM4, &TIM4_Data, TM_PWM_Channel_3, TIM4_Data.Period / 4);
...
/* Led connected to PA5 */
	...
	TM_PWM_SetChannelMicros(TIM2, &TIM2_Data, TM_PWM_Channel_1, 500);
	
/* Nucleo F401-RE LED stop */
