...
void
TM_KEYPAD_Init(TM_KEYPAD_Type_t type) {
    /* Set keyboard type */
...
/* Private */
void
TM_KEYPAD_INT_SetColumn(uint8_t column) {
    /* Set rows high */
...
uint8_t
TM_KEYPAD_INT_CheckRow(uint8_t column) {
    /* Read rows */
