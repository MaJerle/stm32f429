...
TM_HMC5883L_Init(TM_HMC5883L_t* HMC5883L, TM_HMC5883L_Gain_t Gain, TM_HMC5883L_OutputRate_t OutputRate) {
    uint8_t data[3];
...
TM_HMC5883L_Result_t
TM_HMC5883L_DataReady(TM_HMC5883L_t* HMC5883L) {
...
TM_HMC5883L_Result_t
TM_HMC5883L_Read(TM_HMC5883L_t* HMC5883L) {
    uint8_t data[6];
...
TM_HMC5883L_Result_t
TM_HMC5883L_ProcessInterrupt(TM_HMC5883L_t* HMC5883L) {
    /* Set data ready flag */
