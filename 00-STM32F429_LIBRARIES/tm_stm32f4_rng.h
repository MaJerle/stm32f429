 ...
 * @link    http://stm32f4-discovery.net/2014/07/library-22-true-random-number-generator-stm32f4xx/
 * @version v1.1
 * @ide     Keil uVision
 * @license GNU GPL v3
...
/**
 * @defgroup TM_RNG
 * @brief    Random number generator library for STM32F4xx devices - http://stm32f4-discovery.net/2014/07/library-22-true-random-number-generator-stm32f4xx/
 * @{
 *
 * \par Changelog
 *
