...
TM_LIS302DL_LIS3DSH_Detect(void) {
    uint8_t id;
    /* Delay on power up */
...
TM_LIS302DL_LIS3DSH_Device_t
TM_LIS302DL_LIS3DSH_Init(TM_LIS302DL_LIS3DSH_Sensitivity_t Sensitivity, TM_LIS302DL_LIS3DSH_Filter_t Filter) {
    /* Init pinout and SPI */
    TM_LIS302DL_LIS3DSH_INT_InitPins();
    /* Some delay */
    TM_LIS302DL_LIS3DSH_INT_Delay();
...
/* Private */
void
TM_LIS302DL_LIS3DSH_INT_InitPins(void) {
...
void
TM_LIS302DL_LIS3DSH_INT_WriteSPI(uint8_t* data, uint8_t addr, uint8_t count) {
...
void
TM_LIS302DL_LIS3DSH_INT_ReadSPI(uint8_t* data, uint8_t addr, uint8_t count) {
    /* Start SPI transmission */
    LIS302DL_LIS3DSH_CS_LOW;
...
void
TM_LIS302DL_LIS3DSH_INT_InitLIS3DSH(TM_LIS302DL_LIS3DSH_Sensitivity_t Sensitivity, TM_LIS302DL_LIS3DSH_Filter_t Filter) {
    uint8_t tmpreg;
    uint16_t temp;
...
void
TM_LIS302DL_LIS3DSH_INT_InitLIS302DL(TM_LIS302DL_LIS3DSH_Sensitivity_t Sensitivity, TM_LIS302DL_LIS3DSH_Filter_t Filter) {
    uint16_t ctrl;
...
void
TM_LIS3DSH_INT_ReadAxes(TM_LIS302DL_LIS3DSH_t* Axes_Data) {
    int8_t buffer[6];
...
void
TM_LIS302DL_INT_ReadAxes(TM_LIS302DL_LIS3DSH_t* Axes_Data) {
    int8_t buffer[3];
    int16_t SwitchXY;
...
void
TM_LIS302DL_LIS3DSH_INT_Delay(void) {
