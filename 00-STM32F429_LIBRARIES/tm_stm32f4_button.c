...
TM_BUTTON_t*
TM_BUTTON_Init(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, uint8_t ButtonState, void (*ButtonHandler)(TM_BUTTON_PressType_t)) {
...
TM_BUTTON_t*
TM_BUTTON_SetPressTime(TM_BUTTON_t* ButtonStruct, uint16_t Normal, uint16_t Long) {
    /* Set values */
...
/* Internal functions */
void
TM_BUTTON_INT_CheckButton(TM_BUTTON_t* ButtonStruct) {
