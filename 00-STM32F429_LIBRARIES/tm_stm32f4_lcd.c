...
TM_LCD_Result_t
TM_LCD_SetXY(uint16_t X, uint16_t Y) {
...
TM_LCD_Result_t
TM_LCD_SetFont(TM_FontDef_t* Font) {
...
TM_LCD_Result_t
TM_LCD_SetColors(uint32_t Foreground, uint32_t Background) {
    /* Set new colors */
...
TM_LCD_Result_t
TM_LCD_DrawPixel(uint16_t X, uint16_t Y, uint32_t color) {
...
TM_LCD_Result_t
TM_LCD_SetLayer1Opacity(uint8_t opacity) {
    /* Set opacity */
...
TM_LCD_Result_t
TM_LCD_SetLayer2Opacity(uint8_t opacity) {
    /* Set opacity */
...
TM_LCD_Result_t
TM_LCD_DrawLine(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint32_t color) {
...
TM_LCD_Result_t
TM_LCD_DrawRectangle(uint16_t x0, uint16_t y0, uint16_t Width, uint16_t Height, uint32_t color) {
...
TM_LCD_Result_t
TM_LCD_DrawRoundedRectangle(uint16_t x0, uint16_t y0, uint16_t Width, uint16_t Height, uint16_t r, uint32_t color) {
...
TM_LCD_Result_t
TM_LCD_DrawFilledRoundedRectangle(uint16_t x0, uint16_t y0, uint16_t Width, uint16_t Height, uint16_t r, uint32_t color) {
    /* Check input parameters */
...
TM_LCD_Result_t
TM_LCD_DrawFilledRectangle(uint16_t x0, uint16_t y0, uint16_t Width, uint16_t Height, uint32_t color) {
    /* Draw with DMA2D */
...
TM_LCD_Result_t
TM_LCD_DrawCircle(int16_t x0, int16_t y0, int16_t r, uint32_t color) {
    /* Use DMA2D */
...
TM_LCD_Result_t
TM_LCD_DrawFilledCircle(int16_t x0, int16_t y0, int16_t r, uint32_t color) {
    /* Use DMA2D */
...
uint16_t
TM_LCD_GetWidth(void) {
    return LCD.Width;
}

uint16_t
TM_LCD_GetHeight(void) {
    return LCD.Height;
}

uint32_t
TM_LCD_GetFrameBuffer(void) {
    return LCD.FrameStart;
}

/* Private functions */
static void
TM_LCD_INT_InitLTDC(void) {
...
static void
TM_LCD_INT_InitLCD(void) {

}

static void
TM_LCD_INT_InitPins(void) {
    /* LCD pins */
