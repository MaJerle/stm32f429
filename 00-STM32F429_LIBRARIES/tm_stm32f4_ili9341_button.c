...
int8_t
TM_ILI9341_Button_Add(TM_ILI9341_Button_t* button) {
    uint8_t id = 0;
...
void
TM_ILI9341_Button_DrawAll(void) {
    uint8_t id = 0;
...
ErrorStatus
TM_ILI9341_Button_Draw(uint8_t id) {
...
int8_t
TM_ILI9341_Button_Touch(TM_STMPE811_TouchData* TouchData) {
    uint8_t id;
    for (id = 0; id < TM_ILI9341_BUTTON_MAX_BUTTONS; id++) {
...
void
TM_ILI9341_Button_Enable(uint8_t id) {
    //Add enabled flag
    TM_ILI9341_Buttons[id].flags |= TM_BUTTON_FLAG_ENABLED;
}

void
TM_ILI9341_Button_Disable(uint8_t id) {
    //Remove enabled flag
    TM_ILI9341_Buttons[id].flags &= ~TM_BUTTON_FLAG_ENABLED;
}

void
TM_ILI9341_Button_DeleteAll(void) {
    uint8_t i;
...
void
TM_ILI9341_Button_Delete(uint8_t id) {
