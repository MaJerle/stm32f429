...
TM_TIMER_PROPERTIES_GetTimerProperties(TIM_TypeDef* TIMx, TM_TIMER_PROPERTIES_t* Timer_Data) {
...
TM_TIMER_PROPERTIES_Result_t
TM_TIMER_PROPERTIES_GenerateDataForWorkingFrequency(TM_TIMER_PROPERTIES_t* Timer_Data, double frequency) {
...
TM_TIMER_PROPERTIES_Result_t
TM_TIMER_PROPERTIES_EnableClock(TIM_TypeDef* TIMx) {
#ifdef TIM1
    if (TIMx == TIM1) {
...
TM_TIMER_PROPERTIES_Result_t
TM_TIMER_PROPERTIES_DisableClock(TIM_TypeDef* TIMx) {
#ifdef TIM1
    if (TIMx == TIM1) {
        RCC->APB2ENR &= ~RCC_APB2ENR_TIM1EN;
    }
