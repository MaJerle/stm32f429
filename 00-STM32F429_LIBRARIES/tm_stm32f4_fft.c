...
uint8_t
TM_FFT_Init_F32(TM_FFT_F32_t* FFT, uint16_t FFT_Size, uint8_t use_malloc) {
    uint8_t i;
...
void
TM_FFT_SetBuffers_F32(TM_FFT_F32_t* FFT, float32_t* InputBuffer, float32_t* OutputBuffer) {
...
uint8_t
TM_FFT_AddToBuffer(TM_FFT_F32_t* FFT, float32_t sampleValue) {
...
void
TM_FFT_Process_F32(TM_FFT_F32_t* FFT) {
...
void
TM_FFT_Free_F32(TM_FFT_F32_t* FFT) {
    /* Free input buffer */
    if (!FFT->UseMalloc) {
