/**
 *	SWO Debugging library for Cortex-M4/M3 processors including STM32F4xx
 *
 *	@author 	Tilen Majerle
 *	@email		tilen@majerle.eu
 *	@website	http://stm32f4-discovery.com
 *	@link		http://stm32f4-discovery.com/2014/12/
 *	@version 	v1.0
 *	@ide		Keil uVision
 *	@license	GNU GPL v3
 *	
 ...
 *
 * By default, debug mode is active, but if you want to disable it, you can open
 * defines.h file and add following define inside:
 *
...
/* SWO debug is enabled by default */
...
/**
 * Format and output data to the SWO output
 * This function acts similar to printf except that custom stream is used
 * 
 * Parameters:
 *	- args...:
 *		Parameters are like printf. First parameter is string, 
