 ...
 * @link    http://stm32f4-discovery.net/2014/10/library-42-control-rc-servo-stm32f4
 * @version v1.1
 * @ide     Keil uVision
 * @license GNU GPL v3
...
/**
 * @defgroup TM_SERVO
 * @brief    SERVO library for STM32F4xx devices - http://stm32f4-discovery.net/2014/10/library-42-control-rc-servo-stm32f4
 * @{
 *
