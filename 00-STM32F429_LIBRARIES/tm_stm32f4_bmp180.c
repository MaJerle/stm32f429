...
TM_BMP180_Result_t
TM_BMP180_Init(TM_BMP180_t* BMP180_Data) {
    uint8_t data[22];
    uint8_t i = 0;
    ...
    AC1 = (int16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    AC2 = (int16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    AC3 = (int16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    AC4 = (uint16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    AC5 = (uint16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    AC6 = (uint16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    B1 = (int16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    B2 = (int16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    MB = (int16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
    MC = (int16_t)(data[i] << 8 | data[i + 1]);
    i += 2;
...
TM_BMP180_Result_t
TM_BMP180_StartTemperature(TM_BMP180_t* BMP180_Data) {
...
TM_BMP180_Result_t
TM_BMP180_ReadTemperature(TM_BMP180_t* BMP180_Data) {
    uint8_t data[2];
...
TM_BMP180_Result_t
TM_BMP180_StartPressure(TM_BMP180_t* BMP180_Data, TM_BMP180_Oversampling_t Oversampling) {
    uint8_t command;
...
TM_BMP180_Result_t
TM_BMP180_ReadPressure(TM_BMP180_t* BMP180_Data) {
    uint8_t data[3];
...
uint32_t
TM_BMP180_GetPressureAtSeaLevel(uint32_t pressure, float altitude) {
