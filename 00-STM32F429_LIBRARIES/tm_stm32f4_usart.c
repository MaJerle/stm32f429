...
void
TM_USART_Init(USART_TypeDef* USARTx, TM_USART_PinsPack_t pinspack, uint32_t baudrate) {
#ifdef USE_USART1
    if (USARTx == USART1) {
...
void
TM_USART_InitWithFlowControl(USART_TypeDef* USARTx, TM_USART_PinsPack_t pinspack, uint32_t baudrate, TM_USART_HardwareFlowControl_t FlowControl) {
#ifdef USE_USART1
    if (USARTx == USART1) {
...
uint8_t
TM_USART_Getc(USART_TypeDef* USARTx) {
    int8_t c = 0;
...
uint16_t
TM_USART_Gets(USART_TypeDef* USARTx, char* buffer, uint16_t bufsize) {
    uint16_t i = 0;
...
uint8_t
TM_USART_BufferEmpty(USART_TypeDef* USARTx) {
    TM_USART_t* u = TM_USART_INT_GetUsart(USARTx);
...
uint8_t
TM_USART_BufferFull(USART_TypeDef* USARTx) {
    TM_USART_t* u = TM_USART_INT_GetUsart(USARTx);
...
void
TM_USART_ClearBuffer(USART_TypeDef* USARTx) {
    TM_USART_t* u = TM_USART_INT_GetUsart(USARTx);
...
void
TM_USART_SetCustomStringEndCharacter(USART_TypeDef* USARTx, uint8_t Character) {
    /* Get USART structure */
    TM_USART_t* u = TM_USART_INT_GetUsart(USARTx);
...
uint8_t
TM_USART_FindCharacter(USART_TypeDef* USARTx, uint8_t c) {
    uint16_t num, out;
    TM_USART_t* u = TM_USART_INT_GetUsart(USARTx);
...
void
TM_USART_Puts(USART_TypeDef* USARTx, char* str) {
    TM_USART_t* u = TM_USART_INT_GetUsart(USARTx);
...
void
TM_USART_Send(USART_TypeDef* USARTx, uint8_t* DataArray, uint16_t count) {
    uint16_t i;
    TM_USART_t* u = TM_USART_INT_GetUsart(USARTx);
    /* If we are not initialized */
    if (u->Initialized == 0) {
...
/* Private functions */
void
TM_USART_INT_InsertToBuffer(TM_USART_t* u, uint8_t c) {
...
__weak void
TM_USART_InitCustomPinsCallback(USART_TypeDef* USARTx, uint16_t AlternateFunction) {
    /* Custom user function. */
    /* In case user needs functionality for custom pins, this function should be declared outside this library */
}

TM_USART_t*
TM_USART_INT_GetUsart(USART_TypeDef* USARTx) {
    TM_USART_t* u;
...
uint8_t
TM_USART_INT_GetSubPriority(USART_TypeDef* USARTx) {
    uint8_t u;
...
#ifdef USE_USART1
void
TM_USART1_InitPins(TM_USART_PinsPack_t pinspack) {
    /* Init pins */
#if defined(GPIOA)
...
#ifdef USE_USART2
void
TM_USART2_InitPins(TM_USART_PinsPack_t pinspack) {
    /* Init pins */
#if defined(GPIOA)
    if (pinspack == TM_USART_PinsPack_1) {
...
#ifdef USE_USART3
void
TM_USART3_InitPins(TM_USART_PinsPack_t pinspack) {
    /* Init pins */
#if defined(GPIOB)
    if (pinspack == TM_USART_PinsPack_1) {
...
#ifdef USE_UART4
void
TM_UART4_InitPins(TM_USART_PinsPack_t pinspack) {
    /* Init pins */
#if defined(GPIOA)
    if (pinspack == TM_USART_PinsPack_1) {
...
#ifdef USE_UART5
void
TM_UART5_InitPins(TM_USART_PinsPack_t pinspack) {
    /* Init pins */
...
#ifdef USE_USART6
void
TM_USART6_InitPins(TM_USART_PinsPack_t pinspack) {
    /* Init pins */
#if defined(GPIOC)
    if (pinspack == TM_USART_PinsPack_1) {
...
#ifdef USE_UART7
void
TM_UART7_InitPins(TM_USART_PinsPack_t pinspack) {
    /* Init pins */
#if defined(GPIOE)
    if (pinspack == TM_USART_PinsPack_1) {
...
#ifdef USE_UART8
void
TM_UART8_InitPins(TM_USART_PinsPack_t pinspack) {
    /* Init pins */
#if defined(GPIOE)
    if (pinspack == TM_USART_PinsPack_1) {
