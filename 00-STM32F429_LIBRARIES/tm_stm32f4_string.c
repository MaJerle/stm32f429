...
TM_STRING_t*
TM_STRING_Create(uint16_t size) {
    TM_STRING_t* String;
...
uint16_t
TM_STRING_AddString(TM_STRING_t* String, char* str) {
    TM_STRING_t* ptr;
    char** tmp1;
    uint16_t i;
...
TM_STRING_t*
TM_STRING_ReplaceString(TM_STRING_t* String, uint16_t pos, char* str) {
    char* tmp, *tmp1;
...
TM_STRING_t*
TM_STRING_DeleteString(TM_STRING_t* String, uint16_t pos) {
    uint16_t i;
    char* tmp;
...
char*
TM_STRING_GetString(TM_STRING_t* String, uint16_t pos) {
    /* Check input pointer */
    if (String == NULL) {
        return NULL;
    }
...
void
TM_STRING_Free(TM_STRING_t* String) {
    /* Check input pointer */
    if (String == NULL) {
        return;
    }
...
void
TM_STRING_FreeAll(TM_STRING_t* String) {
    uint16_t i;
