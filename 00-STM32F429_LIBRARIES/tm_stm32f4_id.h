 ...
 * @link    http://stm32f4-discovery.net/2014/12/library-44-stm32f4-unique-id-and-flash-size
 * @version v1.0
 * @ide     Keil uVision
 * @license GNU GPL v3
...
/**
 * @defgroup TM_ID
 * @brief    Identification library and flash size for STM32F4xx - http://stm32f4-discovery.net/2014/12/library-44-stm32f4-unique-id-and-flash-size
 * @{
 *
 ...
 *           - 0x2001: Revision 3
 */
#define TM_ID_GetRevision()	(((*(uint32_t *) (ID_DBGMCU_IDCODE))>>16) & 0xFFFF)
