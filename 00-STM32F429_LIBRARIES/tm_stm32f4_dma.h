 ...
 * @link    http://stm32f4-discovery.net/2015/06/library-63-dma-for-stm32f4xx
 * @version v1.1
 * @ide     Keil uVision
 * @license GNU GPL v3
...
/**
 * @defgroup TM_DMA
 * @brief    DMA library for STM32F4xx for several purposes - http://stm32f4-discovery.net/2015/06/library-63-dma-for-stm32f4xx
 * @{
 *
