...
void
TM_DMA_ClearFlags(DMA_Stream_TypeDef* DMA_Stream) {
    /* Clear all flags */
    TM_DMA_ClearFlag(DMA_Stream, DMA_FLAG_ALL);
}

void
TM_DMA_ClearFlag(DMA_Stream_TypeDef* DMA_Stream, uint32_t flag) {
    uint32_t location;
...
uint32_t
TM_DMA_GetFlags(DMA_Stream_TypeDef* DMA_Stream, uint32_t flag) {
...
void
TM_DMA_EnableInterrupts(DMA_Stream_TypeDef* DMA_Stream) {
...
void
TM_DMA_DisableInterrupts(DMA_Stream_TypeDef* DMA_Stream) {
    IRQn_Type IRQValue;
...
/*****************************************************************/
__weak void
TM_DMA_TransferCompleteHandler(DMA_Stream_TypeDef* DMA_Stream) {
...
__weak void
TM_DMA_HalfTransferCompleteHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
...
__weak void
TM_DMA_TransferErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
...
__weak void
TM_DMA_DirectModeErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
...
__weak void
TM_DMA_FIFOErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
...
/*****************************************************************/
static void
TM_DMA_INT_ProcessInterrupt(DMA_Stream_TypeDef* DMA_Stream) {
