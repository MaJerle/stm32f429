...
/* Public */
TM_L3GD20_Result_t
TM_L3GD20_Init(TM_L3GD20_Scale_t scale) {
    /* Init CS pin */
...
uint8_t
TM_L3GD20_INT_ReadSPI(uint8_t address) {
    uint8_t data;
    /* CS low */
    L3GD20_CS_LOW;
...
void
TM_L3GD20_INT_WriteSPI(uint8_t address, uint8_t data) {
    /* CS low */
    L3GD20_CS_LOW;
