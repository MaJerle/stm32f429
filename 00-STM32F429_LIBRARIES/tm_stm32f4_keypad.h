 ...
 * @link    http://stm32f4-discovery.net/2014/09/library-32-matrix-keypad-on-stm32f4xx
 * @version v2.0
 * @ide     Keil uVision
 * @license GNU GPL v3
...
/**
 * @defgroup TM_KEYPAD
 * @brief    Matrix keyboard for STM32F4xx device - http://stm32f4-discovery.net/2014/09/library-32-matrix-keypad-on-stm32f4xx
 * @{
 *
