...
void TM_SPI_SendMulti(SPI_TypeDef* SPIx, uint8_t *dataOut, uint8_t *dataIn, uint8_t count) {
	uint8_t i;
	for (i = 0; i < count; i++) {
...
void TM_SPI_WriteMulti(SPI_TypeDef* SPIx, uint8_t *dataOut, uint8_t count) {
	uint8_t i;
	for (i = 0; i < count; i++) {
...
void TM_SPI_ReadMulti(SPI_TypeDef* SPIx, uint8_t *dataIn, uint8_t dummy, uint8_t count) {
	uint8_t i;
	for (i = 0; i < count; i++) {
