...
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_GetStatus(void) {
    /* Return status */
    return TM_USB_HIDDEVICE_INT_Status;
}
...
/* Mouse */
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_MouseStructInit(TM_USB_HIDDEVICE_Mouse_t* Mouse_Data) {
    /* Set defaults */
...
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_MouseSend(TM_USB_HIDDEVICE_Mouse_t* Mouse_Data) {
...
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_MouseReleaseAll(void) {
...
/* Gamepad */
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_GamepadStructInit(TM_USB_HIDDEVICE_Gamepad_t* Gamepad_Data) {
    /* Set defaults */
...
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_GamepadSend(TM_USB_HIDDEVICE_Gamepad_Number_t gamepad_id, TM_USB_HIDDEVICE_Gamepad_t* Gamepad_Data) {
...
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_GamepadReleaseAll(TM_USB_HIDDEVICE_Gamepad_Number_t gamepad_id) {
...
/* Keyboard */
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_KeyboardStructInit(TM_USB_HIDDEVICE_Keyboard_t* Keyboard_Data) {
    /* Set defaults */
...
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_KeyboardSend(TM_USB_HIDDEVICE_Keyboard_t* Keyboard_Data) {
...
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_KeyboardReleaseAll(void) {
    uint8_t buff[9] = {0, 0, 0, 0, 0, 0, 0, 0, 0}; /* 9 bytes long report */
...
/* Custom report */
TM_USB_HIDDEVICE_Status_t
TM_USB_HIDDEVICE_SendCustom(uint8_t* buff, uint8_t count) {
    /* Check status */
    if (TM_USB_HIDDEVICE_INT_Status != TM_USB_HIDDEVICE_Status_Connected) {
        return TM_USB_HIDDEVICE_Status_Disconnected;
    }
