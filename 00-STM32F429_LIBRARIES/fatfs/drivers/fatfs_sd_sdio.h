...
int TM_FATFS_SD_SDIO_disk_initialize(void);
int TM_FATFS_SD_SDIO_disk_status(void);
int TM_FATFS_SD_SDIO_disk_read(BYTE *buff, DWORD sector, BYTE count);
int TM_FATFS_SD_SDIO_disk_write(const BYTE *buff, DWORD sector, BYTE count);
int TM_FATFS_SD_SDIO_disk_ioctl(BYTE cmd, void *buff);
