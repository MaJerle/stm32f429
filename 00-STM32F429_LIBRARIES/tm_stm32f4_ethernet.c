...
TM_ETHERNET_Init(uint8_t* mac_addr, uint8_t* ip_addr, uint8_t* gateway, uint8_t* netmask) {
    uint8_t i;
...
TM_ETHERNET_Result_t
TM_ETHERNETSERVER_Enable(uint16_t port) {
    if (!Initialized) {
...
TM_ETHERNET_Result_t
TM_ETHERNETSERVER_Disable(void) {
    if (!Initialized) {
        /* If not initialized, return error */
        return TM_ETHERNET_Result_Error;
    }
...
TM_ETHERNET_Result_t
TM_ETHERNET_TimeUpdate(uint16_t millis) {
...
TM_ETHERNET_Result_t
TM_ETHERNETCLIENT_Connect(char* conn_name, uint8_t ip1, uint8_t ip2, uint8_t ip3, uint8_t ip4, uint16_t port, void* user_parameters) {
    err_t e;
...
TM_ETHERNET_Result_t
TM_ETHERNETSERVER_SetSSITags(TM_ETHERNET_SSI_t* SSI_Tags, uint16_t number_of_tags) {
...
TM_ETHERNET_Result_t
TM_ETHERNETSERVER_SetCGIHandlers(const TM_ETHERNET_CGI_t* cgis, uint16_t number_of_handlers) {
    static uint8_t isSet = 0;
    if (!isSet) {
...
TM_ETHERNET_Result_t
TM_ETHERNETDNS_GetHostByName(char* host_name) {
...
/* Common callbacks */
__weak void
TM_ETHERNET_LinkIsDownCallback(void) {

}

__weak void
TM_ETHERNET_LinkIsUpCallback(void) {

}

__weak void
TM_ETHERNET_IPIsSetCallback(uint8_t ip_addr1, uint8_t ip_addr2, uint8_t ip_addr3, uint8_t ip_addr4, uint8_t dhcp) {

}

__weak void
TM_ETHERNET_DHCPStartCallback(void) {

}

__weak void
TM_ETHERNET_SystemResetCallback(void) {

}
/* Client based callbacks */
__weak uint16_t
TM_ETHERNETCLIENT_CreateHeadersCallback(TM_TCPCLIENT_t* connection, char* buffer, uint16_t buffer_length) {
...
__weak void
TM_ETHERNETCLIENT_ConnectionStartedCallback(TM_TCPCLIENT_t* connection) {
    /* Do nothing by default */
}

__weak void
TM_ETHERNETCLIENT_ConnectedCallback(TM_TCPCLIENT_t* connection) {
    /* Do nothing by default */
}

__weak void
TM_ETHERNETCLIENT_ConnectionClosedCallback(TM_TCPCLIENT_t* connection, uint8_t success) {
    /* Do nothing */
...
__weak void
TM_ETHERNETCLIENT_ErrorCallback(TM_TCPCLIENT_t* connection) {

}

__weak void
TM_ETHERNETCLIENT_ReceiveDataCallback(TM_TCPCLIENT_t* connection, uint8_t* buffer, uint16_t buffer_length, uint16_t total_length) {

}

/* Server based callbacks */
__weak uint16_t
TM_ETHERNETSERVER_SSICallback(int iIndex, char* pcInsert, int iInsertLen) {
    /* Return 0 */
    return 0;
}

__weak uint8_t
TM_ETHERNETSERVER_ClientConnectedCallback(struct tcp_pcb* pcb) {
    /* Return 1, allow connection */
    return 1;
}

__weak void
TM_ETHERNETSERVER_ClientDisconnectedCallback(void) {
    /* Do nothing */
}

__weak int
TM_ETHERNETSERVER_OpenFileCallback(struct fs_file* file, const char* name) {
    /* Return 0, custom user file is not opened */
    return 0;
}

__weak int
TM_ETHERNETSERVER_ReadFileCallback(struct fs_file* file, char* buffer, int count) {
    /* Return -1 (End Of File), we read 0 characters */
    return -1;
}

__weak void
TM_ETHERNETSERVER_CloseFileCallback(struct fs_file* file) {
    /* Do nothing */
}

/* Server POST based callbacks */
__weak uint8_t
TM_ETHERNETSERVER_PostRequestBeginCallback(TM_ETHERNETPOST_t* params) {
    return 0;
}

__weak uint8_t
TM_ETHERNETSERVER_PostRequestReceiveDataCallback(TM_ETHERNETPOST_t* params, struct pbuf* p) {
    return 0;
}

__weak void
TM_ETHERNETSERVER_PostRequestEndCallback(void* connection, char* response_uri, u16_t response_uri_len) {

}

/* DNS based callbacks */
__weak void
TM_ETHERNETDNS_FoundCallback(char* host_name, uint8_t ip_addr1, uint8_t ip_addr2, uint8_t ip_addr3, uint8_t ip_addr4) {
...
/* PHY based callbacks */
__weak void
TM_ETHERNETPHY_CustomOptions(uint32_t PHYAddress) {
...
__weak uint8_t
TM_ETHERNET_InitPinsCallback(void) {
...
/* Internal functions */
void
TM_ETHERNET_INT_CustomOptions(uint32_t PHYAddress) {
    /* Call user functions */
...
void
TM_ETHERNET_INT_SetIPAddress(uint8_t ip_addr1, uint8_t ip_addr2, uint8_t ip_addr3, uint8_t ip_addr4, uint8_t dhcp) {
...
void
TM_ETHERNET_INT_LinkIsUpCallback(void) {
    /* Set flag */
    TM_ETHERNET.link_is_up = 1;
...
void
TM_ETHERNET_INT_LinkIsDownCallback(void) {
    /* Set flag */
...
void
TM_ETHERNET_INT_DNSFoundCallback(const char* name, struct ip_addr* ipaddr, void* callback_arg) {
    /* Not working anymore */
    DNS_Working = 0;
    /* Check for IP */
