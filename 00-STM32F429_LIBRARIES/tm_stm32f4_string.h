 ...
 * @link    http://stm32f4-discovery.net/2015/05/library-58-dynamic-strings-on-stm32f4xx
 * @version v1.1
 * @ide     Keil uVision
 * @license GNU GPL v3
...
/**
 * @defgroup TM_STRING
 * @brief    String library for STM32F4xx devices - http://stm32f4-discovery.net/2015/05/library-58-dynamic-strings-on-stm32f4xx
 * @{
 *
