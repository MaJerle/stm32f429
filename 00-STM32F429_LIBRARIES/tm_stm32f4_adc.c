...
void
TM_ADC_Init(ADC_TypeDef* ADCx, uint8_t channel) {
...
void
TM_ADC_InitADC(ADC_TypeDef* ADCx) {
...
uint16_t
TM_ADC_Read(ADC_TypeDef* ADCx, uint8_t channel) {
...
void
TM_ADC_EnableVbat(void) {
    /* Enable VBAT */
    ADC->CCR |= ADC_CCR_VBATE;
}

void
TM_ADC_DisableVbat(void) {
    /* Disable VBAT */
    ADC->CCR &= ~ADC_CCR_VBATE;
}

uint16_t
TM_ADC_ReadVbat(ADC_TypeDef* ADCx) {
    uint32_t result;
...
/* Private functions */
void
TM_ADC_INT_Channel_0_Init(ADC_TypeDef* ADCx) {
    TM_ADC_INT_InitPin(GPIOA, GPIO_PIN_0);
}
void
TM_ADC_INT_Channel_1_Init(ADC_TypeDef* ADCx) {
    TM_ADC_INT_InitPin(GPIOA, GPIO_PIN_1);
}
void
TM_ADC_INT_Channel_2_Init(ADC_TypeDef* ADCx) {
    TM_ADC_INT_InitPin(GPIOA, GPIO_PIN_2);
}
void
TM_ADC_INT_Channel_3_Init(ADC_TypeDef* ADCx) {
    TM_ADC_INT_InitPin(GPIOA, GPIO_PIN_3);
}
void
TM_ADC_INT_Channel_4_Init(ADC_TypeDef* ADCx) {
...
void
TM_ADC_INT_Channel_5_Init(ADC_TypeDef* ADCx) {
    if (ADCx == ADC1 || ADCx == ADC2) {
...
void
TM_ADC_INT_Channel_6_Init(ADC_TypeDef* ADCx) {
    if (ADCx == ADC1 || ADCx == ADC2) {
...
void
TM_ADC_INT_Channel_7_Init(ADC_TypeDef* ADCx) {
    if (ADCx == ADC1 || ADCx == ADC2) {
...
void
TM_ADC_INT_Channel_8_Init(ADC_TypeDef* ADCx) {
    if (ADCx == ADC1 || ADCx == ADC2) {
...
void
TM_ADC_INT_Channel_9_Init(ADC_TypeDef* ADCx) {
    if (ADCx == ADC1 || ADCx == ADC2) {
...
void
TM_ADC_INT_Channel_10_Init(ADC_TypeDef* ADCx) {
    TM_ADC_INT_InitPin(GPIOC, GPIO_PIN_0);
}
void
TM_ADC_INT_Channel_11_Init(ADC_TypeDef* ADCx) {
    TM_ADC_INT_InitPin(GPIOC, GPIO_PIN_1);
}
void
TM_ADC_INT_Channel_12_Init(ADC_TypeDef* ADCx) {
    TM_ADC_INT_InitPin(GPIOC, GPIO_PIN_2);
}
void
TM_ADC_INT_Channel_13_Init(ADC_TypeDef* ADCx) {
    TM_ADC_INT_InitPin(GPIOC, GPIO_PIN_3);
}
void
TM_ADC_INT_Channel_14_Init(ADC_TypeDef* ADCx) {
    if (ADCx == ADC1 || ADCx == ADC2) {
...
void
TM_ADC_INT_Channel_15_Init(ADC_TypeDef* ADCx) {
    if (ADCx == ADC1 || ADCx == ADC2) {
...
void
TM_ADC_INT_InitPin(GPIO_TypeDef* GPIOx, uint16_t PinX) {
    /* Enable GPIO */
