...
void
TM_LOWPOWER_SleepUntilInterrupt(uint8_t delay_timer) {
    /* Disable systick */
    if (delay_timer) {
...
void
TM_LOWPOWER_SleepUntilEvent(void) {
...
void
TM_LOWPOWER_StopUntilInterrupt(void) {
    /* Go to STOP mode */
...
void
TM_LOWPOWER_StopUntilEvent(void) {
    /* Go to STOP mode */
...
void
TM_LOWPOWER_EnableWakeUpPin(void) {
...
void
TM_LOWPOWER_DisableWakeUpPin(void) {
