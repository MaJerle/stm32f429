 ...
 * 
 * 	USB			|STM32F4xx HS in FS mode		|STM32F4xx FS mode			|Notes
 ...
 * But if you are working on other application (or Nucleo board), you only need D+ and D- pins.
 * To disable VBUS pin, add lines belo in your defines.h file:
 * 
 * 	//Disable VBUS pin
