...
TM_SERVO_Result_t
TM_SERVO_Init(TM_SERVO_t* ServoStruct, TIM_TypeDef* TIMx, TM_PWM_Channel_t PWMChannel, TM_PWM_PinsPack_t Pinspack) {
...
TM_SERVO_Result_t
TM_SERVO_SetDegrees(TM_SERVO_t* ServoStruct, float degrees) {
    /* Set PWM value */
    uint16_t micros;
