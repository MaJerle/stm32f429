...
#if defined(STM32F446xx) && !defined(PLL_R)
...
/* Enable HSE if user wants it. Added by TM */
...
void SystemInit_ExtMemCtl(void)
{
	...
	/* Enable GPIOB, GPIOC, GPIOD, GPIOE, GPIOF and GPIOG interface clock */
...
/*-- FMC Configuration ------------------------------------------------------*/
	...
	FMC_Bank5_6->SDCR[1] = (FMC_ColumnBits_Number_8b | 
							SDRAM_ROWBITS_NUMBER | 
							SDRAM_MEMORY_WIDTH |
							FMC_InternalBank_Number_4 |
							FMC_CAS_Latency_3 |
							FMC_Write_Protection_Disable |
							FMC_SDClock_Period_2 |
							SDRAM_READ_BURST_STATE |
